                ...
                <div class="col-md-8">
                    ...
                    <div class="card p-4 mb-4 bg-white rounded" style="box-shadow: 0 4px 15px rgba(220,53,69, 0.3);">
                        ...
                        <div class="col-md-12 text-center">
                            <h1 class="display-4 text-danger">Tabella Richieste</h1>
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="form-group">
                            <label for="permesso" class="form-label text-danger" style="font-weight: bold">Tipo Permesso</label>
                ...
                <table id="RichiesteTable" class="table table-striped table-hover display-responsive table-bordered" style="width:100%">
                    <thead>
                        <tr>
                            ...
                            <th class="text-danger">Nome utente</th>
                            <th class="text-danger">Data inizio</th>
                            <th class="text-danger">Data fine</th>
                            <th class="text-danger">Tipo permesso</th>
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="confermaLabel">Conferma Azione</h5>
                    </div>
                    ...
                    <div class="modal-body">
                        <form id="notificaForm" action="NotificaServlet" method="POST">
                            ...
                            <div class="form-group mt-3">
                                <label for="selezioneEsito">Seleziona esito:</label>
