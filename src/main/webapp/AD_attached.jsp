...
<html>
    ...
    <body>
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header Smartoop-bg-standard">
                        <h5 class="modal-title text-white" id="uploadModalLabel">Carica Allegato</h5>
                    ...
                    <div class="modal-body">
                        ...
                        <form action="AllegatoServlet" method="post" enctype="multipart/form-data">
                            ...
                            <div class="mb-3">
                                <label for="utenteId" class="form-label SmartOOP-text-standard">Seleziona Utente</label>
                            ...
                            <div class="mb-3">
                                <label for="file" class="form-label SmartOOP-text-standard">Seleziona file</label>
                                <input type="file" class="form-control" name="file" required>
                            </div>

                            <div class="mb-3">
                                <label for="note" class="form-label SmartOOP-text-standard">Note</label>
                            ...
                            <div class="mb-3">
                                <label for="tipoDocumento" class="form-label SmartOOP-text-standard">Seleziona Tipo Documento</label>
                ...
                <div class="col-md-8">
                    ...
                    <div class="card p-4 mb-4 bg-white rounded" style="box-shadow: 0 4px 15px rgba(220,53,69, 0.3);">
                        ...
                        <div class="col-md-12 text-center">
                            <h1 class="display-4 SmartOOP-text-standard">Documentazione del personale</h1>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="container-fluid">
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            <label for="tipoDocumentoFiltro" class="form-label SmartOOP-text-standard" style="font-weight: bold">Tipo Documento</label>
        ...
        <div class="container-fluid text-center">
            <button type="button" class="btn Smartoop-btn-standard" data-bs-toggle="modal" data-bs-target="#uploadModal">
                Carica Allegato
            </button>
        </div>
                ...
                <table id="allegatiTable" class="table table-striped table-hover display-responsive table-bordered" style="width:100%; white-space: nowrap;">
                    <thead>
                        <tr>
                            ...
                            <th class="SmartOOP-text-standard">Tipo documento :</th>
