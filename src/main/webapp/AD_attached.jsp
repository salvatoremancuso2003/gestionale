...
<html>
    <head>
        ...
        <title>Allegati Dipendenti</title>
            ...
            <div class="container-fluid">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul class="navbar-nav me-auto">
                        ...
                        <li class="nav-item">
                            <a class="nav-link active d-flex align-items-center" href="AD_attached.jsp">
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="uploadModalLabel">Carica Allegato</h5>
                    ...
                    <div class="modal-body">
                        ...
                        <form action="AllegatoServlet" method="post" enctype="multipart/form-data">
                            ...
                            <div class="mb-3">
                                <label for="utenteId" class="form-label">Seleziona Utente</label>
                                <select name="utenteId" class="form-select" required>
                                    <option value="" disabled selected>Seleziona l'utente</option>
                                    <% for (Utente u : utenti) {%>
                            ...
                            <% List <TipoDocumento> tipiDocumento = Utility.getAllTipiSenzaRichiesta();%>

                            <div class="mb-3">
                                <label for="tipoDocumento" class="form-label">Seleziona Tipo Documento</label>
                                <select name="tipoDocumento" id="tipoDocumento" class="form-select" required>
                                    <option value="" disabled selected>Seleziona tipo documento</option>
                                    <% for (TipoDocumento t : tipiDocumento) { %>
                            ...
                            <div class="modal-footer">
                                ...
                                <button type="submit" class="btn btn-danger">Carica Allegato</button>
                            </div>
                        </form>
                    </div>
                </div>
                ...
                <div class="col-md-8">
                    ...
                    <div class="card p-4 mb-4 bg-white rounded" style="box-shadow: 0 4px 15px rgba(220,53,69, 0.3);">
                        ...
                        <div class="col-md-12 text-center">
                            <h1 class="display-4 text-danger">Documentazione del personale</h1>
                          <!--  <p class="lead mt-4"><%= Utility.checkAttribute(session, "nome")%> , consulta e visualizza la documentazione del personale.</p> -->
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="container-fluid">
            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group">
                            <label for="dataInizio" class="form-label text-danger" style="font-weight: bold">Intervallo data di inizio</label>
                            <input type="date" id="dataInizio" name="dataInizio" class="form-control">
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="form-group">
                            <label for="dataFine" class="form-label text-danger" style="font-weight: bold">Intervallo data di fine</label>
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group">
                            <label for="utente" class="form-label text-danger" style="font-weight: bold">Utente</label>
                    ...
                    <% List <TipoDocumento> AllTipiDocumento = Utility.getAllTipi();%>
                    <div class="col-md-6">
                        <div class="form-group">
                            <label for="tipoDocumentoFiltro" class="form-label text-danger" style="font-weight: bold">Tipo Documento</label>
                            <select name="tipoDocumentoFiltro" id="tipoDocumentoFiltro" class="form-select" required>
                                <option selected="" value="Qualsiasi">Qualsiasi</option>
                                <% for (TipoDocumento t : AllTipiDocumento) { %>
        ...
        <div class="container-fluid">
            <div class="table-responsive">
                <table id="allegatiTable" class="table table-striped table-hover display-responsive table-bordered" style="width:100%">
                    <thead>
                        <tr>
                            <th class="text-danger">Dipendente : </th>
                            <th class="text-danger">Data di upload :</th>
                            <th class="text-danger">Tipo documento :</th>
                            <th class="text-danger">Note :</th>
                            <th class="text-danger">Gestisci :</th>
                        </tr>
                    </thead>
                    <tbody>
                    </tbody>
        ...
        <script>
                            $(document).ready(function () {
                                var table = $('#allegatiTable').DataTable({
                                    "ajax": {
                                        "url": "VisualizzaAllegatiServlet?filesWithDipendenti=" + true,
                                        "type": "POST",
                                        data: function (d) {
                                            d.dataInizio = $("#dataInizio").val();
                                            d.dataFine = $("#dataFine").val();
                                            d.utente = $("#utente").val();
                                            d.tipoDocumentoFiltro = $("#tipoDocumentoFiltro").val();
                                        },
                                        "dataSrc": "aaData",
                                        "dataType": "json"
                                    },
                                ...
                                $("#tipoDocumentoFiltro").change(function () {
                                    table.ajax.reload(null, false);
                                });
                            });
