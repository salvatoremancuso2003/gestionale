                ...
                <div class="col-md-8">
                    ...
                    <div class="card p-4 mb-4 bg-white rounded" style="box-shadow: 0 4px 15px rgba(220,53,69, 0.3);">
                        ...
                        <div class="col-md-12 text-center">
                            <h1 class="display-4 text-danger">Documentazione personale</h1>
                           <!-- <p class="lead mt-4"><%= Utility.checkAttribute(session, "nome")%> , consulta e visualizza la tua documentazione.</p> -->
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="form-group">
                        <label for="dataInizioFiltro" class="form-label text-danger" style="font-weight: bold">Intervallo data di inizio</label>
                        <input type="date" id="dataInizioFiltro" name="dataInizioFiltro" class="form-control">
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="form-group">
                        <label for="dataFineFiltro" class="form-label text-danger" style="font-weight: bold">Intervallo data di fine</label>
                ...
                <table id="allegatiTable" class="table table-striped table-hover table-bordered display-responsive" style="width:100%">
                    <thead>
                        <tr>
                            ...
                            <th class="text-danger">Nome del file :</th>
