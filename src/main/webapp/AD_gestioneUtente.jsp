                ...
                <div class="col-md-8">
                    ...
                    <div class="card p-4 mb-4 bg-white rounded" style="box-shadow: 0 4px 15px rgba(220,53,69, 0.3);">
                        ...
                        <div class="col-md-12 text-center">
                            <h1 class="display-4 text-danger">Gestione Utenti</h1>
        ...
        <div>
            <div class="container">
                <form id="creaUtenteForm" action="InserisciNuovoUtente" method="POST"
                    ...
                    <br>
                    <div class="mb-3">
                        <label for="nome" class="form-label text-danger" style="font-weight: bold">Nome:</label>
                        <input type="text" class="form-control" id="nome" name="nome" required>
                    </div>

                    <div class="mb-3">
                        <label for="cognome" class="form-label text-danger" style="font-weight: bold">Cognome:</label>
                        <input type="text" class="form-control" id="cognome" name="cognome" required>
                    </div>

                    <div class="mb-3">
                        <label for="email" class="form-label text-danger" style="font-weight: bold">Email:</label>
                        <input type="email" class="form-control" id="email" name="email" required>
                    </div>

                    <div class="text-center">
                        <button type="submit" class="btn btn-danger" id="CreaUtente">Crea Utente</button>
                    </div>
                </form>
                    ...
                    <table id="UtenteTable" class="table table-striped table-hover display-responsive table-bordered" style="width:100%">
                        <thead>
                            <tr>
                                ...
                                <th class="text-danger">Cognome </th>
