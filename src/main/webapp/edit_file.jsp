...
<html lang="it">
    ...
    <body>
        ...
        <div class="container mt-5">
            <h2 class="mb-4 text-center text-danger" style="font-weight: bold">Modifica File</h2>
            <form action="UploadAllegatoServlet" method="POST" enctype="multipart/form-data" class="needs-validation" novalidate>
                ...
                <div class="mb-3">
                    <label for="file" class="form-label text-danger" style="font-weight: bold">Seleziona file</label>
