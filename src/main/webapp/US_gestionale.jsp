...
<html lang="it">
    ...
    <body>
        ...
        <!-- Navbar -->
        <nav class="navbar navbar-expand-lg navbar-danger fixed-top w-100">
            <div class="container-fluid">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul class="navbar-nav me-auto">
                        <li class="nav-item">
                            <a class="nav-link active d-flex align-items-center" href="US_gestionale.jsp">
                    ...
                    <div class="ms-auto d-flex align-items-center">
                        ...
                        <div class="me-3 position-relative">
                            <button type="button" class="btn btn-outline-light" id="notificheButton" onclick="mostraNotifiche()">
                        ...
                        <button type="button" class="btn btn-outline-light" id="logoutButton" onclick="logout()">
        ...
        <main class="container mt-5">
            ...
            <div class="row justify-content-center">
                <div class="col-md-8">
                    <!-- Card principale -->
                    <div class="card p-4 mb-4 bg-white rounded" style="box-shadow: 0px 4px 15px 2px rgba(220,53,69, 1);">
                        ...
                        <div class="col-md-12 text-center">
                            <% if(utente != null){
                            %>
                            <h1 class="display-4 text-danger"> Home</h1>
                            <% }else{ 
                            response.sendRedirect("index.jsp");
                            }
                            %>
                            ...
                            <a href="#sezioneCard" class="btn btn-danger btn-lg mt-4">
                                Inizia ora
            ...
            <div id="sezioneCard" class="row text-center mt-5">
                <div class="col-md-4">
                    <div class="card p-3 mb-4 bg-white rounded" style="box-shadow: -6px 6px 6px 2px rgba(220,53,69, 1);">
                        <div class="card-body">
                            <i class="bi bi-calendar3 text-danger" style="font-size: 3rem;"></i>
                            <h5 class="card-title mt-3">Calendario</h5>
                            <p class="card-text">Consulta il calendario delle tue attività.</p>
                            <a href="US_calendar.jsp" class="btn btn-outline-danger">Vai al Calendario</a>
                        </div>
                    </div>
                </div>
                <div class="col-md-4">
                    <div class="card p-3 mb-4 bg-white rounded" style="box-shadow: 0 6px 6px 4px rgba(220,53,69, 1);">
                        <div class="card-body">
                            <i class="bi bi-check-square text-danger" style="font-size: 3rem;"></i>
                            <h5 class="card-title mt-3">Timbratura</h5>
                            <p class="card-text">Timbra il tuo ingresso o la tua uscita giornaliera.</p>
                            <a href="#" class="btn btn-outline-danger" data-bs-toggle="modal" data-bs-target="#timbroModal">Timbra Ora</a>
                            <a href="#" class="btn btn-outline-danger" style="margin-left: 5px;" data-bs-toggle="modal" data-bs-target="#richiediPermessoModal">Richiedi Permesso</a>
                        </div>
                    </div>
                </div>
                <div class="col-md-4">
                    <div class="card p-3 mb-4 bg-white rounded" style="box-shadow: 6px 6px 6px 2px rgba(220,53,69, 1);">
                        <div class="card-body">
                            ...
                            <p class="card-text">Gestisci la tua documentazione.</p>
                            <a href="US_attached.jsp" class="btn btn-outline-danger">Vai alla documentazione</a>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="modal-dialog">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h5 class="modal-title" id="timbroModalLabel">Timbro Giornaliero</h5>
                        ...
                        <div class="modal-body">
                            ...
                            <button type="submit" id="btnRegistrareOra" class="btn btn-danger">Registra Ingresso</button>
                            ...
                            <button type="submit" id="btnRegistrareOra" class="btn btn-danger">Registra Uscita</button>
                            ...
                            <div class="container-fluid">
                                <div class="row justify-content-center">
                                    <div class="col-12 text-center">
                                        ...
                                        %>
                                        <p><strong class="text-danger">Entrata:</strong> <%= entrataFormatted %></p> 
                                        <% 
                                            }
                                            if (p.getUscita() != null) {
        ...
        <div class="modal fade" id="richiediPermessoModal" tabindex="-1" aria-labelledby="richiediPermessoLabel" aria-hidden="true">
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="richiediPermessoLabel">Richiesta Permesso</h5>
                        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                    </div>
                    <div class="modal-body">
                        <form id="richiediPermessoForm" method="POST" action="RichiestaPermessoServlet" enctype="multipart/form-data" onsubmit="validateAndSubmit()">
                            ...
                            <button type="submit" class="btn btn-danger" id="esitoModalButton1" >Invia Richiesta</button>
                        </form>
                    </div>
                </div>
            </div>
        ...
        <div class="modal fade" id="notificheModal" tabindex="-1" aria-labelledby="notificheModalLabel" aria-hidden="true">
            <div class="modal-dialog modal-lg">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="notificheModalLabel">Notifiche</h5>
                        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                    </div>
                    <div class="modal-body">
                            ...
                            <table id="notificheTable" class="table table-bordered table-striped">
                                <thead>
                                    <tr>
                                        ...
                                        <th class="text-danger">Data Creazione</th>
                                        <th class="text-danger">Esito</th>
                                    </tr>
                                </thead>
                                <tbody>
                                </tbody>
                    ...
                    <div class="modal-footer">
                        ...
                        <div>
                            <button type="button" class="btn btn-danger" id="segnaComeLettoButton" onclick="segnaComeLetto()">Segna come già lette</button>
                        </div>
                    </div>
                </div>
            </div>
