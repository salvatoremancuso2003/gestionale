                ...
                <div class="col-md-4">
                    <div class="card p-3 mb-4 bg-white rounded">
                        <div class="card-body">
                            ...
                            <a href="US_calendar.jsp" class="btn Smartoop-btn-outline-standard">Vai al Calendario</a>
                        </div>
                    </div>
                </div>
                <div class="col-md-4">
                    <div class="card p-3 mb-4 bg-white rounded">
                        <div class="card-body">
                            ...
                            <a href="#" class="btn Smartoop-btn-outline-standard" data-bs-toggle="modal" data-bs-target="#timbroModal">Timbra Ora</a>
                            <a href="#" class="btn Smartoop-btn-outline-standard" style="margin-left: 5px;" data-bs-toggle="modal" data-bs-target="#richiediPermessoModal">Richiedi Permesso</a>
                        </div>
                    </div>
                </div>
                <div class="col-md-4">
                    <div class="card p-3 mb-4 bg-white rounded">
                        <div class="card-body">
                            ...
                            <a href="US_attached.jsp" class="btn Smartoop-btn-outline-standard">Vai alla documentazione</a>
                        </div>
                    </div>
                </div>
            </div>
