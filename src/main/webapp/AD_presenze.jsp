                ...
                <div class="col-md-8">
                    ...
                    <div class="card p-4 mb-4 bg-white rounded" style="box-shadow: 0 4px 15px rgba(220,53,69, 0.3);">
                        ...
                        <div class="col-md-12 text-center">
                            <h1 class="display-4 text-danger">Tabella Presenze</h1>
        ...
        <div class="container-fluid">
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group">
                            <label for="presenza" class="form-label text-danger" style="font-weight: bold">Modalità</label>
            ...
            <div class="table-responsive">
                <table id="attendanceTable" class="table table-striped table-hover table-bordered" style="width:100%">
                    <thead>
                        <tr>
                            <th class="text-danger">Nome Completo</th>
                            <th class="text-danger">Tipo</th>
                            <th class="text-danger">Ingresso</th>
                            <th class="text-danger">Uscita</th>
                        </tr>
                    </thead>
                    <tbody>
                    </tbody>
