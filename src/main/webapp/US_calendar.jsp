                ...
                <div class="col-md-8">
                    ...
                    <div class="card p-4 mb-4 bg-white rounded" style="box-shadow: 0 4px 15px rgba(220,53,69, 0.3);">
                        ...
                        <div class="col-md-12 text-center">
                            <h1 class="display-4 text-danger">Calendario</h1>
                            <!-- <p class="lead mt-4"><%= Utility.checkAttribute(session, "nome") %> , consulta e gestisci il tuo calendario delle attività.</p> -->
                        </div>
                    </div>
                </div>
            </div>
