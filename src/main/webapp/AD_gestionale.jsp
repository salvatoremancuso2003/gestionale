            ...
            <div id="sezioneCard" class="row text-center mt-5">
                    ...
                    <div class="col-md-6">
                        <div class="card p-3 mb-4 bg-white rounded" style="box-shadow: -6px 6px 6px 2px rgba(220,53,69, 1);">
                            <div class="card-body">
                                ...
                                <a href="AD_calendar.jsp" class="btn btn-outline-danger">Vai al calendario</a>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="card p-3 mb-4 bg-white rounded" style="box-shadow: 6px 6px 6px 2px rgba(220,53,69, 1);">
                            <div class="card-body">
                                ...
                                <a href="AD_presenze.jsp" class="btn btn-outline-danger">Vai alle presenze</a>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="col-md-6">
                        <div class="card p-3 mb-4 bg-white rounded" style=" box-shadow: -6px 6px 6px 2px rgba(220,53,69, 1);">
                            <div class="card-body">
                                ...
                                <a href="AD_attached.jsp" class="btn btn-outline-danger">Vai alla documentazione</a>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="card p-3 mb-4 bg-white rounded" style="box-shadow: 6px 6px 6px 2px rgba(220,53,69, 1);">
                            <div class="card-body">
                                ...
                                <a href="AD_richiestePermessi.jsp" class="btn btn-outline-danger">Vai ai permessi</a>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="row">
                    <div class="col-md-12">
                        <div class="card p-3 mb-4 bg-white rounded" style=" box-shadow: -6px 6px 6px 2px rgba(220,53,69, 1);">
                            <div class="card-body">
                                <i class="bi bi-person-fill-gear text-danger" style="font-size: 3rem;"></i>
                                <h5 class="card-title mt-3">Utenti</h5>
                                <p class="card-text">Gestisci i tuoi utenti.</p>
                                <a href="AD_gestioneUtente.jsp" class="btn btn-outline-danger">Vai alla gestione degli utenti</a>
                            </div>
                        </div>
                    </div>
                </div>
