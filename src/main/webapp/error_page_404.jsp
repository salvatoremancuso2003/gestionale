            ...
            <div class="row justify-content-center">
                <div class="col-lg-6 col-md-8 col-sm-10">
                    <div class="text-center mt-5">
                        ...
                        <h1 class="kt-error_subtitle">Pagina non trovata</h1>
                        <p class="kt-error_description">Ci dispiace, la pagina che stai cercando non è disponibile.</p>
                        <p class="kt-error_description">
                            <button id="back_btn" class="btn btn-danger"><i class="fa fa-backspace"></i> Torna indietro</button>
                        </p>
                        <hr style="color: #dc3545; border: 1px solid #dc3545">
                    </div>
                </div>
