    ...
    <body>
                ...
                <div class="col-md-8">
                    ...
                    <div class="card p-4 mb-4 bg-white rounded" style="box-shadow: 0 4px 15px rgba(220,53,69, 0.3);">
                        ...
                        <div class="col-md-12 text-center">
                            <h1 class="display-4 text-danger">Benvenuto <%= Utility.checkAttribute(session, "nome") %> ! </h1>
        ...
        <div class="container">
            <form id="creaUtenteForm" action="InserisciNuovoUtente" method="POST"
                ...
                <div class="mb-3">
                    <label for="password" class="form-label text-danger" style="font-weight: bold">Nuova password</label>
                    <div class="input-group">
                        <input type="password" class="form-control" id="password" name="password" required>
                        <button type="button" class="btn btn-outline-danger" id="togglePassword">
                ...
                <div class="mb-3">
                    <label for="password2" class="form-label text-danger" style="font-weight: bold">Conferma nuova password</label>
                    <div class="input-group">
                        <input type="password" class="form-control" id="password2" name="password2" required>
                        <button type="button" class="btn btn-outline-danger" id="togglePassword2">
                            <i class="bi bi-eye-slash"></i>
                        </button>
                    </div>
                </div>
                ...
                <div class="text-center">
                    <button type="submit" class="btn btn-danger" id="AggiornaPassword">Aggiorna password</button>
                </div>
            </form>
        </div>
