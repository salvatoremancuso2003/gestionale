            ...
            if (utente == null) {
                ...
                for (FileEntity e : files) {
                    ...
                    String scarica = "<div class='container-fluid'>"
                            ...
                            + "<button class='btn btn-danger'>Scarica File</button>"
                            + "</form>"
                            + "</div>";
                    ...
                    if (e.getUser().getId().equals(userId)) {
                        editForm = "<div class='col-auto'>"
                                + " <button class='btn btn-danger' style='min-width: 100px; margin-left: 5px;' data-fancybox data-src=\"edit_file.jsp?fancybox=false&id=" + e.getId() + "\" data-type=\"iframe\" data-options='{\"iframe\" : {\"css\": {\"width\": \"90%\", \"height\": \"90%\"}}}'>Modifica File</button>" + "</div>";
        ...
        try {
            ...
            for (FileEntity e : files) {
                ...
                String scarica
                        ...
                        + "<input type = 'hidden' name='filename' value='" + e.getFilename() + "' />"
                        + "<input type='hidden' name='isDownload' value='true' />"
                        + "<button class='btn btn-danger' style='min-width: 100px;'>Scarica File</button>"
                        + "</form>"
                        + "</div>";
...
//                        + "</form>";
                deleteForm
                        ...
                        + "<input type = 'hidden' name='isDownload' value='" + true + "' />"
                        + "<button class='btn btn-danger' style='min-width: 100px; margin-left: 5px;' >Elimina File</button>"
                        + "</form>"
                        + "</div>";
