            ...
            if (isRemove) {
                ...
                try {
                    if (userId != null) {
                        ...
                        Utility.rimuoviUtenteCompletamente(utente);
                        logfile.info("Utente rimosso con successo!");
                        response.sendRedirect("AD_gestioneUtente.jsp?esito=OK2&codice=007&userId=" + userIdParam);
                    } else {
                    ...
                    logfile.severe(estraiEccezione(e));
                    response.sendRedirect("AD_gestioneUtente.jsp?esito=KO2&codice=007&userId=" + userIdParam);
                }
            }
